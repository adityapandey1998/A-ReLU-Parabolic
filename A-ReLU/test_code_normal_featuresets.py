...
FScore 
Leaky AReLU - 90.90, 99.54, 66.66
Leaky ReLU - 90.90, 99.54, 66.66
AReLU - 90.90, 99.69, 80.00
ReLU - 90.09, 99.54, 66.66
...
X_train = pd.concat([df_majority, df_minority1_upsampled, df_minority2_upsampled])
y_train = pd.concat([y_df_majority, y_df_minority1_upsampled, y_df_minority2_upsampled])
